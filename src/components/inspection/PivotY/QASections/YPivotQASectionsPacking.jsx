...
const YPivotQASectionsPacking = () => {
  ...
  const fetchSections = async () => {
    ...
    try {
      const response = await axios.get(
        `${API_BASE_URL}/api/qa-sections-packing`
      );
      ...
      Swal.fire("Error", "Failed to load packing sections", "error");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleSaveSectionName = async (sectionId) => {
    ...
    try {
      ...
      const response = await axios.put(
        `${API_BASE_URL}/api/qa-sections-packing/${sectionId}`,
        {
      ...
      Swal.fire("Error", "Failed to update section name", "error");
    }
  };
    ...
    if (result.isConfirmed) {
      try {
        const response = await axios.delete(
          `${API_BASE_URL}/api/qa-sections-packing/${sectionId}/items/${itemNo}`
        );
    ...
    try {
      ...
      if (response.data.success) {
        Swal.fire({
          icon: "success",
          title: "Created!",
          text: `New section created with Section No: ${response.data.data.sectionNo}`,
          timer: 1500,
          showConfirmButton: false
        });
        fetchSections();
  ...
  const handleSaveItemToSection = async (sectionId) => {
    ...
    try {
      const response = await axios.post(
        `${API_BASE_URL}/api/qa-sections-packing/${sectionId}/items`,
        newItemForSection
      );
        ...
        <div className="bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-indigo-900/20 dark:to-blue-900/20 p-6 rounded-lg shadow-lg border-2 border-indigo-200 dark:border-indigo-700">
          ...
          <div className="mb-4">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
              Section No will be auto-generated
            </p>
          </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      min="1"
                      className="w-20 p-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 focus:ring-2 focus:ring-indigo-500"
                    />
                  </div>
                  <button
          ...
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead className="bg-gray-100 dark:bg-gray-700">
              <tr>
                ...
                <th className="px-6 py-4 text-center text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider w-24">
                  Max Count
                </th>
...
export default YPivotQASectionsPacking;
